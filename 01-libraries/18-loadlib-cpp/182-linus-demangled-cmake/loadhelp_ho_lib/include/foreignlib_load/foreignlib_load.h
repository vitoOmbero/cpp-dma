#ifndef FOREIGNLIB_LOAD_H
#define FOREIGNLIB_LOAD_H

#include <stddef.h>
#include <stdint.h>

#include "resprov/resprov.h"
...
static const char* CreateSuperbMatrix  = "CreateSuperbMatrix";
static const char* SuperbMatrixCount   = "SuperbMatrixCount";
static const char* getSuperbMatrixRows = "getSuperbMatrixRows";
static const char* getDescriptorStatus = "getDescriptorStatus";
static const char* DestroySuperbMatrix = "DestroySuperbMatrix";
#endif // EXTERN_C
} // namespace foreignlib_load::symbols
#endif
